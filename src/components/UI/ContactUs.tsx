...
const SuccessMessage = ({ eventLink, closeDrawer }) => (
  <div className="p-4 text-center">
    ...
    <p className="text-[#462d22]/70 mb-6">جزئیات جلسه به ایمیل شما ارسال شد.</p>
    ...
    {eventLink && (
      <a 
        ...
        className="text-[#ffa620] hover:underline block mb-6"
      >
        مشاهده جلسه در تقویم
      </a>
    )}
...
export default function ContactUs() {
  ...
  const goToNextStep = () => {
    if (currentStep === 1 && !session) {
      // If not authenticated and trying to go to step 2, sign in first
      signIn('google');
      return;
    }
...
md:px-[25px]">
      ...
      <DrawerContent>
        ...
        {bookingSuccess ? (
          <SuccessMessage eventLink={eventLink} closeDrawer={closeDrawer} />
        ) : (
          <>
            {currentStep === 1 && (
              <>
