          ...
          <div className="py-8 px-4 sm:rounded-lg sm:px-10">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 flex flex-col space-y-4">
                ...
                >
                  <ArrowLeft className={`${hasFaSubdomain ? 'ml-2' : 'mr-2'} h-4 w-4 ${hasFaSubdomain ? 'rotate-180' : ''}`} />
      ...
      <div className="hidden md:block md:flex-1 bg-gradient-to-br from-[#ffb62f] to-[#e07902] relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-10">
          <div className={`max-w-md text-white`}>
            <h2 className={`text-3xl font-bold mb-6 ${hasFaSubdomain ? 'titr' : 'roboto'}`}>{t.auth.joinPlatform}</h2>
